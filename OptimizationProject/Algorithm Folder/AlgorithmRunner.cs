...
namespace OptimizationProject.Algorithm_Folder
{
    ...
    {
        public Result RunAlgorithm(Graph graph,int StartingPopulation, double ProbabilityCrossOver, double ProbabilityMutation, int TimeGeneratorSeed, StopCondition Condition, int ConditionValue, ResultType resultType)
        {
